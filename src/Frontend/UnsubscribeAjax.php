...
/**
 * Handles the {@code rosendsms_dash_unsubscribe} AJAX action.
 *
...
final class UnsubscribeAjax {
	...
	public function register(): void {
		add_action( 'wp_ajax_rosendsms_dash_unsubscribe', array( $this, 'handle' ) );
		add_action( 'wp_ajax_nopriv_rosendsms_dash_unsubscribe', array( $this, 'handle' ) );
	}
